...
typedef enum {
    ...
    MSG_VOICE_SPEAKING   = 0x0019,  /* {"names":[...]} who is talking now */
    MSG_VOICE_MEMBERS_STALE = 0x001A, /* {"guild_id":...} refetch channels */
    MSG_MIC_CONFIG       = 0x001B,  /* how to capture */
    ...
    MSG_VOICE_RX_STATS   = 0x0029,  /* {rx,drop,under,resync,trim} report */
    MSG_MIC_STATS        = 0x002A,  /* capture counters */
    MSG_MIC_EVENT        = 0x002B,  /* mic state changed */
    MSG_ERROR            = 0x00FF,
} dawncord_msg_type;
